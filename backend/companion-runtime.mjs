  ...
  try {
    if (req.method === "GET" && req.url === "/health") {
      ...
      return json(res, 200, {
        ...
        build: gradle.exitCode === 0,
        test: adb.connected > 0 && gradle.exitCode === 0,
        install: adb.connected > 0,
        logcat: adb.connected > 0,
        screenshot: adb.connected > 0,
        adb: adb.result.exitCode === 0,
        gradle: gradle.exitCode === 0,
        connectedDevices: adb.connected
      });
    }
